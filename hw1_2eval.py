...
if os.path.isdir('realval_img'):
  shutil.rmtree('realval_img')

if os.path.isdir('realval_label'):
  shutil.rmtree('realval_label')
...
for k in os.listdir(test_dir):
  if '.jpg' in k:
    a=k.strip('.jpg')
    b,c=a.split('_')
    shutil.copyfile(test_dir+'/'+str(k),'realval_img/'+str(int(b))+'.jpg')

  elif '.png' in k:
    a=k.strip('.png')
    b,c=a.split('_')
    shutil.copyfile(test_dir+'/'+str(k),'realval_label/'+str(int(b))+'.png')
